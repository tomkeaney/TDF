...
Stage_list <- list(stage_1_results, stage_2_results, stage_3_results, stage_4_results,
                   ...
                   #stage_11_results, stage_12_results, stage_13_results, stage_14_results, stage_15_results, stage_16_results, stage_17_results, stage_18_results, stage_19_results, stage_20_results, stage_21_results)
...
Results_complete <- 
  ...
  mutate(Yellow_wearer_points = case_when(BIB == 101 | BIB == 106 | BIB == 31 ~ "10",
         ...
         Breakaway_points = case_when(BIB == 188 | BIB == 167 | 
                                        ...
                                        BIB == 25 | BIB == 96 | BIB == 36 | BIB == 181 | BIB == 128 |
                                        BIB == 28 | BIB == 111 | BIB == 201 | BIB == 178 | BIB == 135 |
                                        BIB == 35 | BIB == 174 | BIB == 147 | BIB == 152 | BIB == 206 |
                                        BIB == 126 | BIB == 156 ~ "5",
  ...
  mutate(GC_points = replace_na(GC_points, 0),
         ...
         Jersey_points = Yellow_wearer_points + Green_wearer_points + White_wearer_points + 
           Polka_wearer_points,
         `Green points` = recode(BIB, "81" = 10, "1" = 8/2, "41" = 6, .default = 0),
