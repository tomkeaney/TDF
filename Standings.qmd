...
Stage_list <- list(stage_1_results, stage_2_results, stage_3_results, stage_4_results,
                   ...
                   stage_9_results, stage_10_results, stage_11_results, stage_12_results, stage_13_results, stage_14_results, stage_15_results)
...
Results_complete <- 
  ...
  mutate(Yellow_wearer_points = case_when(BIB == 181 | BIB == 11 | BIB == 111  ~ "10",
         ...
         Polka_wearer_points = case_when(BIB == 202 | BIB == 11 ~ "5",
                                         .default = "0"),
         Domestique_points = case_when(BIB == 3 ~ "12",
                                       BIB == 8 ~ "7",
                                       BIB == 12 ~ "11",
                                       BIB == 101 | BIB == 104 ~ "10",
                                         .default = "0")) %>% 
  ...
  mutate(GC_points = replace_na(GC_points, 0),
         ...
         `White points` = recode(BIB, "71" = 10, "31" = 8, "64" = 6, .default = 0),
         `Mountain points` = recode(BIB, "11" = 10, "1" = 6, "71" = 4, .default = 0),
