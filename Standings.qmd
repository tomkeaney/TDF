...
Teams <- 
  tibble(`Rider type` = c("General", "General", "General", "General", "Domestique", "Sprinter", "Sub 1", "Sub 2", "12 month PCS points"),
         Zing = c("Pogačar Tadej (1)*", "Cavendish Mark (330)", "Martinez Lenny (32)", "Bilbao Pello (17)", "Almeida Joao (26)", "Pedersen Mads (DNF)", "Landa Mikel (Subbed in)", "Onley Oscar (86)", "10,968"),
