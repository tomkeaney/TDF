...
Results_complete <- 
  ...
  mutate(Yellow_wearer_points = case_when(BIB == 181 ~ "10",
                                          .default = "0"),
         Green_wearer_points = case_when(BIB == 187 ~ "5",
                                         .default = "0"),
         White_wearer_points = case_when(BIB == 187 ~ "5",
                                         .default = "0"),
