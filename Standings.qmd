...
Results_complete <- 
  ...
  mutate(Directeur = case_when(
    ...
    BIB == 161| BIB == 26| BIB == 41| BIB == 45| BIB == 6 ~ "Falcs",
    BIB == 19| BIB == 101| BIB == 106| BIB == 21| BIB == 65 ~ "Zing",
    BIB == 91 | BIB == 37| BIB == 81| BIB == 164 ~ "Stiff",
    BIB == 71| BIB == 62 | BIB == 3 | BIB == 5 | BIB == 56 ~ "Willo",
    .default = "Not selected"
  )) %>% 
  # add the jersey wearing points
  mutate(Yellow_wearer_points = case_when(BIB == 19 ~ "10",
                                          .default = "0"),
         Green_wearer_points = case_when(BIB == 19 | BIB == 125 ~ "5",
                                         .default = "0"),
         White_wearer_points = case_when(BIB == 11 ~ "5",
                                         .default = "0"),
         Polka_wearer_points = case_when(BIB == 46 ~ "5",
                                         .default = "0")) %>% 
  ungroup() %>% 
  ...
  mutate(GC_points = replace_na(GC_points, 0),
         ...
         Jersey_points = Yellow_wearer_points + Green_wearer_points + White_wearer_points + 
           Polka_wearer_points,
         `Green points` = recode(BIB, "125" = 10, "11" = 8, "6" = 6, .default = 0),
         `Mountain points` = recode(BIB, "46" = 10, "1" = 6, "11" = 4, .default = 0),
