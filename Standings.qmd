...
Stage_list <- list(stage_1_results, stage_2_results, stage_3_results, stage_4_results,
                   ...
                   stage_9_results, stage_10_results, stage_11_results, stage_12_results, stage_13_results, stage_14_results)
...
Teams <- 
  tibble(`Rider type` = c("General", "General", "General", "General", "Domestique", "Sprinter", "Sub 1", "Sub 2", "12 month PCS points"),
         ...
         Ben = c("Rodriguez Carlos (16)", "Ayuso Juan (DNF)", "Ciccone Giulio (133)", "Matthews Michael (69)", "Bettiol Alberto (42)", "Philipsen Jasper (2)", "Carapaz Richard (Subbed in)", "Martin Guillaume (47)", "8,768"),
...
Results_complete <- 
  ...
  mutate(Directeur = case_when(
    ...
    BIB == 31 | BIB == 13| BIB == 41| BIB == 26| BIB == 112 | BIB == 106 | BIB == 111 ~ "Ben",
  ...
  mutate(Yellow_wearer_points = case_when(BIB == 181 | BIB == 11 | BIB == 111  ~ "10",
         ...
         White_wearer_points = case_when(BIB == 187 | BIB == 71 ~ "5",
                                         .default = "0"),
         Polka_wearer_points = case_when(BIB == 202 | BIB == 11 ~ "5",
                                         .default = "0"),
         Domestique_points = case_when(BIB == 3 ~ "10",
                                       BIB == 8 ~ "5",
                                       BIB == 12 ~ "8",
                                       BIB == 101 | BIB == 104 ~ "10",
                                         .default = "0")) %>% 
  ...
  mutate(GC_points = replace_na(GC_points, 0),
         ...
         `Mountain points` = recode(BIB, "11" = 10, "1" = 6, "202" = 4, .default = 0),
