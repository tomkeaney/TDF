...
Stage_list <- list(stage_1_results, stage_2_results, stage_3_results, stage_4_results,
                   ...
                   stage_9_results)
                   #, stage_5_results, stage_6_results, stage_7_results, stage_8_results, stage_9_results, stage_10_results, stage_11_results, stage_12_results, stage_13_results, stage_14_results,stage_15_results, stage_16_results, stage_17_results, stage_18_results, stage_19_results, stage_20_results, stage_21_results)
```
...
Teams %>%
  mutate(Zing = cell_spec(Zing, "html", strikeout = ifelse(Zing == "Pedersen Mads (4)", TRUE, FALSE))) %>%  
...
Results_complete <- 
  ...
  mutate(Directeur = case_when(
    ...
    BIB == 11| BIB == 191| BIB == 96| BIB == 61| BIB == 12 | BIB == 45 | BIB == 74 ~ "Zing",
  ...
  mutate(GC_points = replace_na(GC_points, 0),
         ...
         Jersey_points = Yellow_wearer_points + Green_wearer_points + White_wearer_points + 
           Polka_wearer_points,
         `Green points` = recode(BIB, "172" = 10, "106" = 8, "202" = 6, .default = 0),
         `White points` = recode(BIB, "71" = 10, "13" = 8, "31" = 6, .default = 0),
         `Mountain points` = recode(BIB, "202" = 10, "11" = 6, "95" = 4, .default = 0),
